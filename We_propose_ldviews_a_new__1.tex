We propose \ldviews, a new approach to reduce the computational cost of RDF query processing, supporting faster query execution than SPARQL and reduced server load to provide high availability.
